...
--
-- Host: localhost
-- Generation Time: Jan 04, 2021 at 12:10 PM
...
--
-- Database: `predictingflight_delays`
--
CREATE DATABASE IF NOT EXISTS `predictingflight_delays` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predictingflight_delays`;
...
('fowopfko36rhvg58xr4c4126fpedve6a', 'eyJ1c2VyaWQiOjN9:1ktmU6:BjWd3hs0vaQPcdf-JM2qCSX4LTER6D6Esbs30Hmc9Mw', '2021-01-11 06:58:26.616932'),
...
--
-- Table structure for table `remote_user_flight_delays_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_flight_delays_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fname` varchar(300) NOT NULL,
  `ratings` int(11) NOT NULL,
  `likes` int(11) NOT NULL,
  `names` varchar(100) NOT NULL,
  `from1` varchar(200) NOT NULL,
  `dij` varchar(200) NOT NULL,
  `sc_dpt` varchar(300) NOT NULL,
